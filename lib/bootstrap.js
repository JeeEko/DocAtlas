...
import { copyFile, ensureDir, getToolkitRoot, readVersion, writeText } from './paths.js';
...
export function bootstrapProject(projectRoot, options = {}) {
  ...
  const cursorSkills = ['docatlas-skill-init', 'docatlas-skill-refine', 'docatlas-skill-discovery', 'docatlas-skill-drift'];
